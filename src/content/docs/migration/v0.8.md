...
The `AdiEncoder` struct now requires you to specify a custom encoder Ticks Per Revolution value.
...
// @diff +
const VEX_ENCODER_TPR: u32 = 360;
// @diff +
let encoder = AdiEncoder::<VEX_ENCODER_TPR>::new(peripherals.adi_a, peripherals.adi_b);
```
