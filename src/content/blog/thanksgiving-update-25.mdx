...
> [!TIP]
> vexide is a Rust library for programming VEX robots, empowering students and competitors to write safe and efficient code for your robot in the Rust programming language. [Learn more.](/docs/#what-is-vexide)
