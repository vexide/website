...
If you'd like to upgrade a project from v0.7 to v0.8, you can use our automatic migration tool to do much of the hard part for you:
...
Even if you run the upgrade tool with no complications, we still recommend reading through all of the [API Changes](#api-changes) included in v0.8 to get a good idea of what's changed and make sure the upgrade tool didn't miss anything.

# Manual Upgrade Guide

Here's a comprehensive guide on upgrading to vexide v0.8 from v0.7. Apart from the [API Changes](#api-changes), most of these differences can be handled by our [Automatic Migration Tool](#automatic-migration-tool).
...
Install the latest version of cargo-v5.
